...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	private void setFoodLocation() {
		...
		Location location = new Location(random.nextInt(15), random.nextInt(12));
		...
		if(snake.isLocationOnSnake(location) == true) {
			setFoodLocation();
		}
	}
	...
	private void gameOver() {
		...
		String input = JOptionPane.showInputDialog(null, "Snake is dead, would you like to play again (yes or no)");
